<html>
	<?php
		...
		if (isset($_POST['shoplist']))
		{
			...
			/// Si == ALL redirection vers la page de stat global
			if ($_SESSION['selector'] == 0)
				header("location:youfid_master_stats.php");
		}
		$_SESSION['selector_current_location'] = "youfid_master_stats_marchand.php";
		...
		<form id="stats_form" method="post" action="youfid_master_stats_marchand_export.php">
			...
			<div class="stats_content_left left">
				...
				<div id="button_holder">
					...
					<input type="button" onclick="onClickCalculerMarchand()" value="Calculer!">
