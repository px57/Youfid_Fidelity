		...
		<form id="marchand_push">
			...
			<div class="new_merchant_up_right left">
				<div class="text_region">
					...
					<label>Contenu (max.165 car.):</label>
					<textarea name="push_msg" title="Le message de votre PUSH" id="push_msg" rows="10" placeholder="Message" onKeyUp="checkNbCar(165,'push_msg','NBCAR',true);"></textarea>
					<b id="NBCAR"></b>
					<br />
