	...
	<body>
        <div class="col-md-offset-4 col-md-4 login-part">
            <form action="exportmarchand-launch.php" method="post">
                ...
                <div class="form-group">
                    <label for="email" class="text-left">Boite mail sur laquelle recevoir l'export : </label>
