<?php
	...
	$marchand_id= $_SESSION['selector'];
		...
		$logger->log('debug', 'calc_promo2', "GetIn::linkMessageToUsers", Logger::GRAN_MONTH);
	...
	$userArray = array();
		...
		while ($row = mysql_fetch_array($resultUse)) {
			...
			$logger->log('debug', 'calc_promo2', "GetOut::AfterFirstSelect (= ". $testUse . ")::ProcessedIn:: " . $page_load_time . " seconds", Logger::GRAN_MONTH);
	...
	*/
		...
		$timeend2=microtime(true);
			$time=$timeend2-$timestart;	
			$page_load_time = number_format($time, 3);
			$logger->log('debug', 'calc_promo2', "GetOut::Fidelity_filter::ProcessedIn:: " . $page_load_time . " seconds", Logger::GRAN_MONTH);
	...
	$timeend3=microtime(true);
			$time=$timeend3-$timestart;	
			$page_load_time = number_format($time, 3);
			$logger->log('debug', 'calc_promo2', "GetOut::Scanloc_filter::ProcessedIn:: " . $page_load_time . " seconds", Logger::GRAN_MONTH);
	...
	if (isset($_POST['time'])) {
		...
		$timeend4=microtime(true);
			$time=$timeend4-$timestart;	
			$page_load_time = number_format($time, 3);
			$logger->log('debug', 'calc_promo2', "GetOut::time_filter::ProcessedIn:: " . $page_load_time . " seconds", Logger::GRAN_MONTH);
		...
		if (isset($_POST['last_authent'])) {
			...
			$timeend5=microtime(true);
			$time=$timeend5-$timestart;	
			$page_load_time = number_format($time, 3);
			$logger->log('debug', 'calc_promo2', "GetOut::last_authent_filter::ProcessedIn:: " . $page_load_time . " seconds", Logger::GRAN_MONTH);
		...
		$userArray = array_values($userArray);
			...
			$timeend6=microtime(true);
			$time=$timeend6-$timestart;	
			$page_load_time = number_format($time, 3);
			$logger->log('debug', 'calc_promo2', "GetOut::minpoints_filter::ProcessedIn:: " . $page_load_time . " seconds", Logger::GRAN_MONTH);
		...
		$timeend7=microtime(true);
			$time=$timeend7-$timestart;	
			$page_load_time = number_format($time, 3);
			$logger->log('debug', 'calc_promo2', "GetOut::ancient_filter:: " . $page_load_time . " seconds", Logger::GRAN_MONTH);
		...
		$timeend8=microtime(true);
			$time=$timeend8-$timestart;	
			$page_load_time = number_format($time, 3);
			$logger->log('debug', 'calc_promo2', "GetOut::nextPresent_filter::ProcessedIn:: " . $page_load_time . " seconds", Logger::GRAN_MONTH);
		...
		if (isset($_POST['submit1'])) {
			...
			$page_load_time = number_format($time, 3);
			$logger->log('debug', 'calc_promo2', "GetOut::Submit1::ProcessedIn:: " . $page_load_time . " seconds", Logger::GRAN_MONTH);
		...
		elseif (isset($_POST['submit2']) && count($userArray)) {
			...
			$logger->log('debug', 'calc_promo2', "SQL get marchand id = :: " . $getMarchandId . " and num rows = " . mysql_num_rows($marchandResult), Logger::GRAN_MONTH);
			...
			if ($_SESSION['role'] == "youfid_master" && !empty($idPromo)) {
				...
				//mysql_query("INSERT INTO `push_cron` VALUES (NULL, '" . mysql_real_escape_string($push_content) . "'");
			...
			$time=$timeend-$timestart;	
			$page_load_time = number_format($time, 3);
			$logger->log('debug', 'calc_promo2', "GetOut::submit2::ProcessedIn:: " . $page_load_time . " seconds", Logger::GRAN_MONTH);
		...
		elseif (isset($_POST['email'])) {
			...
			if ($_SESSION['role'] == "youfid_master") {
					//$valid = '1'; call send mail
			}
			
			$timeend=microtime(true);
			$time=$timeend-$timestart;	
			$page_load_time = number_format($time, 3);
			$logger->log('debug', 'calc_promo2', "GetOut::email::ProcessedIn:: " . $page_load_time . " seconds", Logger::GRAN_MONTH);
		...
		elseif (isset($_POST['email_before'])) {
			...
			$time=$timeend-$timestart;	
			$page_load_time = number_format($time, 3);
			$logger->log('debug', 'calc_promo2', "GetOut::email_before::ProcessedIn:: " . $page_load_time . " seconds", Logger::GRAN_MONTH);
			header("location:../marchand_email_promo.php");
		}
		header("location:../marchand_promos.php");
