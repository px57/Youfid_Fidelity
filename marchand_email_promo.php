<?php
	...
	<form class="inlineform" action="lib/calc_promo2.php" method="post" accept-charset="UTF-8">
			<br/> <br/> <br/>
			Objet :
			<br/> <br/>
			...
			<br/> <br/> <br/>
		    <input type='submit' name='email' value='Envoyer à <?php echo count($_SESSION['nb_client']) ?> clients'>  </form>       <FORM class="inlineform" METHOD='LINK' ACTION='marchand_promos.php'><INPUT TYPE='submit' VALUE='Retour'></FORM>
